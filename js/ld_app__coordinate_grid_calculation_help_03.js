...
var Calc_coords = function( input_ ){
	...
	this.intersection_testing01 = function(){
		...
		this.settings_n_data_objects_array[ num_of_curr_settings_obj ].points__global_subdivision__gridsize_latitude_y__in_km = 200;
		this.settings_n_data_objects_array[ num_of_curr_settings_obj ].points__global_subdivision__gridsize_longitude_x__in_km = 200;
...
*/
			...
			var overlap_btw_keep_and_compare_array_points = true;
	...
	*/
				...
				if( dist_btw_pts < curr_max_degree_distance_to_other_point ){
					...
					overlap_btw_keep_and_compare_array_points = false;
			...
			if( overlap_btw_keep_and_compare_array_points == true ){
...
*/
	...
	this.settings_and_data_obj = function( super_ ){
		...
		//  longitude y 
		this.geo_limits__global__top_latitude_limit__as_decimal__from_top_to_bottom = 0.0;
		this.geo_limits__global__bottom_latitude_limit__as_decimal__from_top_to_bottom = 1;
