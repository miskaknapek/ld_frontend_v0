...
var Calc_coords = function( input_ ){
	...
	this.generate_grid_points_for_given_settings_object = function( given_settings_obj ){
		...
		if( given_settings_obj.what_kind_of_points_layout == given_settings_obj.what_kind_of_points_layout__preset__global_subdivision ){							
			...
			for( var curr_lat__in_radians = given_settings_obj.geo_limits__global__top_latitude_limit__as_decimal__from_top_to_bottom ; curr_lat__in_radians < given_settings_obj.geo_limits__global__bottom_latitude_limit__as_decimal__from_top_to_bottom; curr_lat__in_radians += curr_vertical_angle_steplength_given_vertical_steplength__as_decimal_of_half_circle ){
					...
					// feedback 
					// console.log("\n ---- points gen loop : \n\t curr lat decimal : "+curr_lat__in_radians );

					// get circumference at this angle 
					var curr_circumference__in_km__at_this_decimal_half_circle_angle = this.get__curr_circumference__in_km__at_this_decimal_half_circle_angle( curr_lat__in_radians );
					...
					for( var curr_long__in_radians = given_settings_obj.geo_limits__global__left_longitude_limit__as_decimal__from_left_to_right ; curr_long__in_radians < given_settings_obj.geo_limits__global__right_longitude_limit__as_decimal__from_left_to_right; curr_long__in_radians += curr_horisontal_steplength_as_decimal_of_circle_given_curr_circumference_and_desired_horisontal_stepsize_in_km ){


						// console.log(" --- ---- --- now adding angle |"+curr_long__in_radians+"| ");
						/*
							to do : 
								- get final position …
						...
						*/
						...
						//////// var curr_long__in_radians_as_angle__in_radians = curr_long__in_radians; 


						// get longX position … 
						var curr_LON_as_coord_sys_angle = this.get__bounded_coord_system_LONG_coord_from_decimal_coord_value( curr_long__in_radians );


						// ------------  SAVE POSTITIONS ------------

						var curr_out_coords_set = { "lat_angle_in_radians" : curr_lat__in_radians, "lat_angle_as_coord_sys_degrees" : curr_lat_as_coord_sys_angle, "lon_angle_in_radians" : curr_long__in_radians, "long_angle_as_coord_sys_degrees" : curr_LON_as_coord_sys_angle };
...
*/
	...
	this.settings_and_data_obj = function( super_ ){
		...
		this.points__global_subdivision__gridsize_latitude_y__in_km = 25;
		this.points__global_subdivision__gridsize_longitude_x__in_km = 25;
		...
		this.geo_limits__global__bottom_latitude_limit__as_decimal__from_top_to_bottom = 0.5;
